...
; window 0: [0.019215375, 32.019215375] lhs=13.355984 rhs=32.000000
; window 1: [0.019215375, 33.019215375] lhs=26.725055 rhs=33.000000
; window 2: [0.019215375, 54.019215375] lhs=41.317585 rhs=54.000000
; window 3: [0.019215375, 66.019215375] lhs=56.142073 rhs=66.000000
; window 4: [0.019215375, 76.019215375] lhs=72.117104 rhs=76.000000
; window 5: [0.019215375, 88.019215375] lhs=84.655468 rhs=88.000000
(declare-fun e_A_leg1 () Real)
(declare-fun e_A_leg2 () Real)
(declare-fun e_B_leg1 () Real)
(declare-fun e_B_leg2 () Real)
(assert (<= 0.019215 e_A_leg1))
(assert (<= (+ e_A_leg1 14.592530 0.100000) 54.019215))
(assert (<= 0.019215 e_A_leg2))
(assert (<= (+ e_A_leg2 15.975031 0.100000) 76.019215))
(assert (<= 0.019215 e_B_leg1))
(assert (<= (+ e_B_leg1 14.824488 0.100000) 66.019215))
(assert (<= 0.019215 e_B_leg2))
(assert (<= (+ e_B_leg2 12.538364 0.100000) 88.019215))
