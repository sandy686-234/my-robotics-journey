...
; window 0: [0.014675166, 32.014675166] lhs=13.355984 rhs=32.000000
; window 1: [0.014675166, 33.014675166] lhs=26.725055 rhs=33.000000
; window 2: [0.014675166, 54.014675166] lhs=41.317585 rhs=54.000000
; window 3: [0.014675166, 66.014675166] lhs=56.142073 rhs=66.000000
; window 4: [0.014675166, 76.014675166] lhs=72.117104 rhs=76.000000
; window 5: [0.014675166, 88.014675166] lhs=84.655468 rhs=88.000000
(declare-fun e_A_leg1 () Real)
(declare-fun e_A_leg2 () Real)
(declare-fun e_B_leg1 () Real)
(declare-fun e_B_leg2 () Real)
(assert (<= 0.014675 e_A_leg1))
(assert (<= (+ e_A_leg1 14.592530 0.100000) 54.014675))
(assert (<= 0.014675 e_A_leg2))
(assert (<= (+ e_A_leg2 15.975031 0.100000) 76.014675))
(assert (<= 0.014675 e_B_leg1))
(assert (<= (+ e_B_leg1 14.824488 0.100000) 66.014675))
(assert (<= 0.014675 e_B_leg2))
(assert (<= (+ e_B_leg2 12.538364 0.100000) 88.014675))
