...
(assert (>= s_A_leg0 0.013263))
(assert (>= s_A_leg1 0.013263))
(assert (>= s_A_leg2 0.013263))
(assert (>= s_B_leg0 0.013263))
(assert (>= s_B_leg1 0.013263))
(assert (>= s_B_leg2 0.013263))

; Deadline constraints
(assert (<= (+ s_A_leg0 13.355984) 32.013263))
(assert (<= (+ s_A_leg1 14.592530) 54.013263))
(assert (<= (+ s_A_leg2 15.975031) 76.013263))
(assert (<= (+ s_B_leg0 13.369071) 33.013263))
(assert (<= (+ s_B_leg1 14.824488) 66.013263))
(assert (<= (+ s_B_leg2 12.538364) 88.013263))
