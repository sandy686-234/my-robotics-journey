...
(assert (>= s_A_leg0 0.018215))
(assert (>= s_A_leg1 0.018215))
(assert (>= s_A_leg2 0.018215))
(assert (>= s_B_leg0 0.018215))
(assert (>= s_B_leg1 0.018215))
(assert (>= s_B_leg2 0.018215))

; Deadline constraints
(assert (<= (+ s_A_leg0 13.355984) 32.018215))
(assert (<= (+ s_A_leg1 14.592530) 54.018215))
(assert (<= (+ s_A_leg2 15.975031) 76.018215))
(assert (<= (+ s_B_leg0 13.369071) 33.018215))
(assert (<= (+ s_B_leg1 14.824488) 66.018215))
(assert (<= (+ s_B_leg2 12.538364) 88.018215))
