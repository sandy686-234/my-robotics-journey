...
; window 0: [0.013852416, 32.013852416] lhs=14.839724 rhs=32.000000
(assert (! (<= 14.839724354 32.000000000) :named w0))
; window 1: [0.013852416, 33.013852416] lhs=29.693190 rhs=33.000000
(assert (! (<= 29.693190126 33.000000000) :named w1))
; window 2: [0.013852416, 54.013852416] lhs=45.831288 rhs=54.000000
(assert (! (<= 45.831288356 54.000000000) :named w2))
; window 3: [0.013852416, 56.013852416] lhs=62.212942 rhs=56.000000
(assert (! (<= 62.212942387 56.000000000) :named w3))
; window 4: [0.013852416, 76.013852416] lhs=79.802667 rhs=76.000000
(assert (! (<= 79.802666741 76.000000000) :named w4))
; window 5: [0.013852416, 78.013852416] lhs=93.783890 rhs=78.000000
