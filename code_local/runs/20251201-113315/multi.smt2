...
; window 0: [0.011621166, 32.011621166] lhs=13.355984 rhs=32.000000
; window 1: [0.011621166, 33.011621166] lhs=26.725055 rhs=33.000000
; window 2: [0.011621166, 54.011621166] lhs=41.317585 rhs=54.000000
; window 3: [0.011621166, 66.011621166] lhs=56.142073 rhs=66.000000
; window 4: [0.011621166, 76.011621166] lhs=72.117104 rhs=76.000000
; window 5: [0.011621166, 88.011621166] lhs=84.655468 rhs=88.000000
(declare-fun e_A_leg1 () Real)
(declare-fun e_A_leg2 () Real)
(declare-fun e_B_leg1 () Real)
(declare-fun e_B_leg2 () Real)
(assert (<= 0.011621 e_A_leg1))
(assert (<= (+ e_A_leg1 14.592530 0.100000) 54.011621))
(assert (<= 0.011621 e_A_leg2))
(assert (<= (+ e_A_leg2 15.975031 0.100000) 76.011621))
(assert (<= 0.011621 e_B_leg1))
(assert (<= (+ e_B_leg1 14.824488 0.100000) 66.011621))
(assert (<= 0.011621 e_B_leg2))
(assert (<= (+ e_B_leg2 12.538364 0.100000) 88.011621))
