...
(assert (>= s_A_leg0 0.021812))
(assert (>= s_A_leg1 0.021812))
(assert (>= s_A_leg2 0.021812))
(assert (>= s_B_leg0 0.021812))
(assert (>= s_B_leg1 0.021812))
(assert (>= s_B_leg2 0.021812))

; Deadline constraints
(assert (<= (+ s_A_leg0 13.355984) 32.021812))
(assert (<= (+ s_A_leg1 14.592530) 54.021812))
(assert (<= (+ s_A_leg2 15.975031) 76.021812))
(assert (<= (+ s_B_leg0 13.369071) 33.021812))
(assert (<= (+ s_B_leg1 14.824488) 66.021812))
(assert (<= (+ s_B_leg2 12.538364) 88.021812))
