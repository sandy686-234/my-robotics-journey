...
; window 0: [0.0142005, 17.0142005] lhs=16.188790 rhs=17.000000
(assert (! (<= 16.188790205 17.000000000) :named w0))
; window 1: [0.0142005, 18.0142005] lhs=32.392571 rhs=18.000000
(assert (! (<= 32.392571046 18.000000000) :named w1))
; window 2: [0.0142005, 34.0142005] lhs=49.997769 rhs=34.000000
(assert (! (<= 49.997769116 34.000000000) :named w2))
; window 3: [0.0142005, 36.0142005] lhs=67.868664 rhs=36.000000
(assert (! (<= 67.868664422 36.000000000) :named w3))
; window 4: [0.0142005, 54.0142005] lhs=87.057455 rhs=54.000000
(assert (! (<= 87.057454627 54.000000000) :named w4))
; window 5: [0.0142005, 56.0142005] lhs=102.309698 rhs=56.000000
