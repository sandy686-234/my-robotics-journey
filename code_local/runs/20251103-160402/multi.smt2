...
; window 0: [0.013116541, 32.013116541] lhs=14.839724 rhs=32.000000
(assert (! (<= 14.839724354 32.000000000) :named w0))
; window 1: [0.013116541, 33.013116541] lhs=29.693190 rhs=33.000000
(assert (! (<= 29.693190126 33.000000000) :named w1))
; window 2: [0.013116541, 54.013116541] lhs=45.831288 rhs=54.000000
(assert (! (<= 45.831288356 54.000000000) :named w2))
; window 3: [0.013116541, 56.013116541] lhs=62.212942 rhs=56.000000
(assert (! (<= 62.212942387 56.000000000) :named w3))
; window 4: [0.013116541, 76.013116541] lhs=79.802667 rhs=76.000000
(assert (! (<= 79.802666741 76.000000000) :named w4))
; window 5: [0.013116541, 78.013116541] lhs=93.783890 rhs=78.000000
