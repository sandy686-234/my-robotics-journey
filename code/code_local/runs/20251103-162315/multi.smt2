...
; window 0: [0.012955, 32.012955] lhs=13.879793 rhs=32.000000
(assert (! (<= 13.879793266 32.000000000) :named w0))
; window 1: [0.012955, 33.012955] lhs=27.773328 rhs=33.000000
(assert (! (<= 27.773327949 33.000000000) :named w1))
; window 2: [0.012955, 54.012955] lhs=42.951495 rhs=54.000000
(assert (! (<= 42.951495091 54.000000000) :named w2))
; window 3: [0.012955, 66.012955] lhs=58.373218 rhs=66.000000
(assert (! (<= 58.373218032 66.000000000) :named w3))
; window 4: [0.012955, 76.012955] lhs=75.003011 rhs=76.000000
(assert (! (<= 75.003011298 76.000000000) :named w4))
; window 5: [0.012955, 88.012955] lhs=88.024303 rhs=88.000000
(assert (! (<= 88.024303467 88.000000000) :named w5))
