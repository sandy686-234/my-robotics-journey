...
; window 0: [0.013849625, 32.013849625] lhs=13.879793 rhs=32.000000
(assert (! (<= 13.879793266 32.000000000) :named w0))
; window 1: [0.013849625, 33.013849625] lhs=27.773328 rhs=33.000000
(assert (! (<= 27.773327949 33.000000000) :named w1))
; window 2: [0.013849625, 54.013849625] lhs=42.951495 rhs=54.000000
(assert (! (<= 42.951495091 54.000000000) :named w2))
; window 3: [0.013849625, 56.013849625] lhs=58.373218 rhs=56.000000
(assert (! (<= 58.373218032 56.000000000) :named w3))
; window 4: [0.013849625, 76.013849625] lhs=75.003011 rhs=76.000000
(assert (! (<= 75.003011298 76.000000000) :named w4))
; window 5: [0.013849625, 78.013849625] lhs=88.024303 rhs=78.000000
