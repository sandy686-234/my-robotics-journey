...
; window 0: [0.013423125, 32.013423125] lhs=13.355984 rhs=32.000000
(assert (! (<= 13.355983742 32.000000000) :named w0))
; window 1: [0.013423125, 33.013423125] lhs=26.725055 rhs=33.000000
(assert (! (<= 26.725054548 33.000000000) :named w1))
; window 2: [0.013423125, 54.013423125] lhs=41.317585 rhs=54.000000
(assert (! (<= 41.317584839 54.000000000) :named w2))
; window 3: [0.013423125, 66.013423125] lhs=56.142073 rhs=66.000000
(assert (! (<= 56.142073034 66.000000000) :named w3))
; window 4: [0.013423125, 76.013423125] lhs=72.117104 rhs=76.000000
(assert (! (<= 72.117104395 76.000000000) :named w4))
; window 5: [0.013423125, 88.013423125] lhs=84.655468 rhs=88.000000
...
(assert (<= 0.013423 e_A_leg1))
(assert (<= (+ e_A_leg1 14.592530 0.100000) 54.013423))
(assert (<= 0.013423 e_A_leg2))
(assert (<= (+ e_A_leg2 15.975031 0.100000) 76.013423))
(assert (<= 0.013423 e_B_leg1))
(assert (<= (+ e_B_leg1 14.824488 0.100000) 66.013423))
(assert (<= 0.013423 e_B_leg2))
(assert (<= (+ e_B_leg2 12.538364 0.100000) 88.013423))
